	...
	public ControlPanel() {
		...
		mRectangle.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				r.addAttributes(new ColorAttributes(true,false,Color.GREEN,Color.BLUE));
		...
		mCircle.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				SCircle c = new SCircle(new Point(200,150),20);
		...
		mText.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				SText t= new SText(new Point(150,150),"Coucou");
				t.addAttributes(new ColorAttributes(true,true,Color.GREEN,Color.RED));
